...
# CLIENT_ID = 'XXX'
# CLIENT_SECRET = 'XXX'
CLIENT_ID = "27f2827b-6219-4a46-9774-34aa15aed551"
CLIENT_SECRET = "e2903f659edf57e4031bd3205fccb284ba7b46203e1c0734f2555c0d57da5041"
...
async def get_items_airtable(credentials) -> list[IntegrationItem]:
    ...
    for response in list_of_responses:
        ...
        tables_response = requests.get(
            f'https://api.airtable.com/v0/meta/bases/{response.get("id")}/tables?properties=name,age,email,department',
            headers={"Authorization": f'Bearer {credentials.get("access_token")}'},
        )
        print(f"tables_response: {tables_response.json()}")
