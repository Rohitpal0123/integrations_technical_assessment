...
CLIENT_ID = '33f204fe-8e98-4fc7-9d0a-ec790062b9bd'
CLIENT_SECRET = 'secret_T4tQIIls96kXDC9p1kazofUY8g7cOMt6HvILiJbi27J'
encoded_client_id_secret = base64.b64encode(f'{CLIENT_ID}:{CLIENT_SECRET}'.encode()).decode()

REDIRECT_URI = 'http://127.0.0.1:8000/integrations/notion/authorize'
authorization_url = f'https://api.notion.com/v1/oauth/authorize?client_id=33f204fe-8e98-4fc7-9d0a-ec790062b9bd&response_type=code&owner=user&redirect_uri=https%3A%2F%2F127.0.0.1%3A8000%2Fintegrations%2Fnotion%2Fauthorize'
